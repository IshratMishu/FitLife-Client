...
const Advantages = () => {
    ...
    return (
        <div className="mt-80 md:mt-32 max-w-screen-xl mx-auto">
            ...
            <div className="m-5 grid grid-cols-1 md:grid-cols-3 gap-5">
                <div className="flex items-center gap-2 border p-4  hover:bg-[#495E57] hover:text-white shadow-md" data-aos="flip-left">
