    ...
    return (
        <div className="mt-28">
            <div className="flex gap-3 items-center ml-10">
                <img className="w-20 h-20 rounded-full" src={fit.image} alt="" />
                <div>
                    <p><span className="font-semibold text-lg">Provider Name:</span> {fit.name}</p>
            ...
            <div className="card bg-base-100 shadow-xl lg:m-5 m-2">
                ...
                <div className="card-body">
                    ...
                    <div className='flex items-center gap-2 mx-auto'>
                        ...
                        <img className='w-12 h-12 rounded-full' src={fit.image} alt="" />
                        <p>{fit.name}</p>
                    </div>
